...
$(".buy").click(function(){
  ...
  $("#base").append('<div class="row row-cart" id="'+idx+'"> <div class="col s6"><img src="'+$(".buy").attr("ng")+'" class="cart-tmb"></div><h6>T-SHIRT</h6> <div class="col s6 white">$ ₹300</div><a href="#" class="delete-cart" id="'+idx+'"><i class="small material-icons">delete</i></a></div>')
  window.setTimeout(function() {
